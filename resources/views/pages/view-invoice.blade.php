                ...
                <div class="flex justify-between xl:gap-60 lg:gap-48 md:gap-16 sm:gap-8 sm:flex-row flex-col gap-4">
                    <div class="w-full">
                        ...
                        <div class="flex flex-col">
                            <div class="text-sm text-gray-400  mt-3">
                                {{trans('messages.invoices.view.bill_from')}}:
                            </div>
                        ...
                        <div class="mt-6">
                            <div class="mt-4">
                                <div class="text-sm text-gray-400">
                                    {{trans('messages.invoices.view.bill_to')}}:
                                </div>
                                <div class="text-lg font-bold">
                                ...
                                @php
                                    $address = $this->getRecord()->billedFor?->address;
                                @endphp
                                @if($address)
                                    <div class="text-sm">
                                        {{$address}}
                    ...
                    <div class="w-full flex flex-col">
                        <div class="flex justify-end font-bold">
                            <div>
                                <div>
                                    <h1 class="text-3xl uppercase">{{trans('messages.invoices.view.invoice')}}</h1>
                                </div>
                                <div>
                                    #{{$this->getRecord()->uuid}}
                                </div>
                            ...
                            <div class="flex flex-col justify-end">
                                <div>
                                    <div class="flex justify-between gap-4">
                                        <div class="text-gray-400">{{trans('messages.invoices.view.issue_date')}} : </div>
                                        <div>{{$this->getRecord()->created_at->toDateString()}}</div>
                                    </div>
                                    <div class="flex justify-between gap-4">
                                        <div class="text-gray-400">{{trans('messages.invoices.view.due_date')}} : </div>
                                        <div>{{$this->getRecord()->due_date->toDateString()}}</div>
                                    </div>
                                    <div class="flex justify-between gap-4">
                                        <div class="text-gray-400">{{trans('messages.invoices.view.status')}} : </div>
                                        {{-- <div>{{type_of($this->getRecord()->status, 'invoices', 'status')->name}}</div> --}}
                                        <div>{{$this->getRecord()->status}}</div>
                                    </div>
                                    <div class="flex justify-between gap-4">
                                        <div class="text-gray-400">{{trans('messages.invoices.view.type')}} : </div>
                                        {{-- <div>{{type_of($this->getRecord()->type, 'invoices', 'type')->name}}</div> --}}
                                        <div>{{$this->getRecord()->type}}</div>
                ...
                <div>
                        ...
                        <div class="flex flex-col">
                            <div class="flex justify-between  px-4 py-2 border-gray-200 dark:border-gray-700 font-bold border-b text-start">
                                <div class="p-2 w-full">
                                    {{trans('messages.invoices.view.item')}}
                                </div>
                                <div class="p-2 w-full">
                                    {{trans('messages.invoices.view.total')}}
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="flex flex-col mt-2">
                                                <div>
                                                    <div class="flex justify-between">
                                                        <span class="text-sm text-gray-400 uppercase w-full">{{trans('messages.invoices.view.price')}}:</span>
                                                        <span class="w-full">
                                                ...
                                                <div>
                                                    <div class="flex justify-between">
                                                        <span class="text-sm text-gray-400 uppercase w-full">{{trans('messages.invoices.view.vat')}}:</span>
                                                        <span class="w-full">
                                                ...
                                                <div>
                                                    <div class="flex justify-between">
                                                        <span class="text-sm text-gray-400 uppercase w-full">{{trans('messages.invoices.view.discount')}}:</span>
                                                        <span class="w-full">
                                                ...
                                                <div>
                                                    <div class="flex justify-between">
                                                        <span class="text-sm text-gray-400 uppercase w-full">{{trans('messages.invoices.view.qty')}}:</span>
                                                        <span class="w-full">
                                                    {{ $item->qty }}
                                                </span>
                                                    </div>
                                                ...
                                                <div>
                                                    <div class="flex justify-between">
                                                        <span class="text-sm text-gray-400 uppercase w-full">{{trans('messages.invoices.view.total')}}:</span>
                    ...
                    <div class="flex justify-between mt-6">
                        <div class="flex flex-col justify-end gap-4 w-full">
                            @if($this->getRecord()->is_bank_transfer)
                                <div>
                                    <div class="mb-2 text-xl">
                                        {{trans('messages.invoices.view.bank_account')}}
                                    </div>
                                    <div class="text-sm flex flex-col">
                                        <div>
                                            <span clas="text-gray-400">{{trans('messages.invoices.view.name')}}</span> : <span class="font-bold">{{ $this->getRecord()->bank_name }}</span>
                                        </div>
                                        <div>
                                            <span clas="text-gray-400">{{trans('messages.invoices.view.address')}}</span> : <span class="font-bold">{{ $this->getRecord()->bank_address }}, {{ $this->getRecord()->bank_city }}, {{ $this->getRecord()->bank_country}}</span>
                                        </div>
                                        <div>
                                            <span clas="text-gray-400">{{trans('messages.invoices.view.branch')}}</span> : <span class="font-bold">{{ $this->getRecord()->bank_branch }}</span>
                                        </div>
                                        <div>
                                            <span clas="text-gray-400">{{trans('messages.invoices.view.swift')}}</span> : <span class="font-bold">{{ $this->getRecord()->bank_swift }}</span>
                                        </div>
                                        <div>
                                            <span clas="text-gray-400">{{trans('messages.invoices.view.account')}}</span> : <span class="font-bold">{{ $this->getRecord()->bank_account }}</span>
                                        </div>
                                        <div>
                                            <span clas="text-gray-400">{{trans('messages.invoices.view.owner')}}</span> : <span class="font-bold">{{ $this->getRecord()->bank_account_owner }}</span>
                                        </div>
                                        <div>
                                            <span clas="text-gray-400">{{trans('messages.invoices.view.iban')}}</span> : <span class="font-bold">{{ $this->getRecord()->bank_iban }}</span>
                                        </div>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div>
                                <div class="mb-2 text-xl">
                                    {{trans('messages.invoices.view.signature')}}
                                </div>
                                <div class="text-sm text-gray-400">
                                    <div>
                                        {{ $this->getRecord()->billedFrom?->name }}
                        ...
                        <div class="flex flex-col gap-2 mt-4  w-full">
                            <div class="flex justify-between">
                                <div class="font-bold">
                                    {{trans('messages.invoices.view.subtotal')}}
                                </div>
                                <div>
                            ...
                            <div class="flex justify-between">
                                <div class="font-bold">
                                    {{trans('messages.invoices.view.tax')}}
                                </div>
                                <div>
                            ...
                            <div class="flex justify-between">
                                <div class="font-bold">
                                    {{trans('messages.invoices.view.discount')}}
                                </div>
                                <div>
                            ...
                            <div class="flex justify-between border-b border-gray-200 dark:border-gray-700 pb-4">
                                <div class="font-bold">
                                    {{trans('messages.invoices.view.paid')}}
                                </div>
                                <div>
                            ...
                            <div class="flex justify-between text-xl font-bold">
                                <div>
                                    {{trans('messages.invoices.view.balance_due')}}
                                </div>
                                <div>
                    ...
                    @if($this->getRecord()->notes)
                        ...
                        <div>
                            <div class="mb-2 text-xl">
                                {{trans('messages.invoices.view.notes')}}
                            </div>
                            <div class="text-sm text-gray-400">
