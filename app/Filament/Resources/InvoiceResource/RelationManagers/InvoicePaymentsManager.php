...
class InvoicePaymentsManager extends RelationManager
{
    ...
    {
        return trans('messages.invoices.payments.title');
    }
    ...
    {
        return trans('messages.invoices.payments.single');
    }
        ...
        return $table
            ...
            ->columns([
                Tables\Columns\TextColumn::make('value')
                    ->label(trans('messages.invoices.payments.columns.amount'))
                    ->money(locale: 'en')
                    ->numeric()
                    ->sortable(),
                Tables\Columns\TextColumn::make('created_at')
                    ->label(trans('messages.invoices.payments.columns.created_at'))
                    ->dateTime()
                    ->sortable()
            ])
            ->filters([
